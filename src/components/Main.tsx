        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col items-center text-center order-1 lg:order-2">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              <Link to="/sponsor">
                <button
                  className="px-10 py-4 rounded-xl bg-transparent border-2 border-white/20 hover:border-white/40 hover:bg-white/5 transition-all text-white font-bold text-lg shadow-lg transform hover:scale-105 active:scale-95 backdrop-blur-sm"
                >
                  Sponsor Us
                </button>
              </Link>
