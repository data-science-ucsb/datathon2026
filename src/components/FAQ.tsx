  ...
  return (
    <section id="faq" className="py-32 px-6 bg-gray-950/50">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl md:text-4xl font-bold bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 bg-clip-text text-transparent mb-4 text-center">Frequently Asked Questions</h2>
