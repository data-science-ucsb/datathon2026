...
const SCHEDULE_DAY1 = [
  ...
  { time: '10:30 - 12:00 PM', event: 'Group Sign-Ups + Build Time' },
  { time: '12:00 - 1:00 PM', event: 'Lunch' },
  { time: '1:00 - 2:00 PM', event: 'Survey of Models Workshop' },
  { time: '2:00 - 4:00 PM', event: 'Build Time (Tech Dev OH)' },
  { time: '4:00 - 5:00 PM', event: 'NLP Workshop' },
  { time: '5:00 - 6:00 PM', event: 'Professional Dev Workshop' },
  { time: '6:00 - 7:00 PM', event: 'Dinner' },
  { time: '7:00 - 8:00 PM', event: 'Deployment Workshop' },
